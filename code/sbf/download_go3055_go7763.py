...
from sbf.sbf_campaign_runtime import atomic_write_json, sha256_file
...
MANIFESTS = {
    "3055": CODE_DIR / "config" / "targets_go3055_manifest.csv",
    "7763": CODE_DIR / "config" / "targets_additional_manifest.csv",
}
