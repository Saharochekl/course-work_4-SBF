...
class PortablePathTests(unittest.TestCase):
    ...
    def test_spectral_reader_resolves_legacy_source_products(self):
        from sbf.sbf2_normalized_winsor_core import inspect_source
        ...
        with patch("sbf.sbf_paths.PROJECT_ROOT", self.root):
    ...
    def test_spectral_table_reader_accepts_relative_result_paths(self):
        from sbf.sbf2_normalized_winsor_core import load_result_tables
